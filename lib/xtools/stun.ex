...
###
### @maintainer: Jahred Love <me@jah.red>
###
### Copyright (c) 2012 Peter Lemenkov <lemenkov@gmail.com>
###
### Copyright (c) 2013 - 2019 Jahred Love and Xirsys LLC <experts@xirsys.com>
###
### All rights reserved.
###
...
defmodule XTools.Stun do
  use Bitwise
  require Logger

  @moduledoc """
  The XTools.Stun module provides the RFC 5389 implementation of the STUN protocol for both encoding and decoding.
  """
  ...
  ## Example
        ...
        iex> XTools.Stun.decode(request)
        {:ok, %XTools.Stun{ attrs: %{}, class: :request, fingerprint: false, integrity: false, key: nil, method: :binding, ns: nil, peer_id: nil, transactionid: 177565706535525809372192520}}
  """
  ...
  ## Example
        ...
        ...> }}
        iex> XTools.Stun.encode(response)
  ...
  """
  def encode(%XTools.Stun{} = config) do
  ...
  ## Example
        ...
        ...>   software: <<"XMediaLib-stun">>
        ...> }} |> Stun.encode()
        iex> XTools.Stun.pretty(response)
        {:ok,
          %{
            attrs: %{
              mapped_address: "127.0.0.1:12345",
  ...
  defp maybe_insert_fingerprint(stun_binary, %XTools.Stun{} = config) do
  ...
  defp maybe_insert_integrity(stun_binary, %XTools.Stun{key: key}) when not is_nil(key),
    do: insert_integrity(stun_binary, key)

  defp maybe_insert_integrity(stun_binary, %XTools.Stun{}), do: stun_binary
